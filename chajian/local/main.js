        ...
        if (adaptationOk) {
            ...
            function start() {
                ...
                var middleHtml = `<div id="zqwM159">
                    <div class="zqwM159-main">
                        ...
                        <div class="zqwM159-douYin">
                            ...
                            <div class="zqwM159-box zqwM159-box-douYin">
                                <ul></ul>
                            </div>
                        </div>
                    ...
                    <div class="zqwM159-coupon zqwClear"></div>
                </div>`;
                ...
                !function () {
                    ...
                    $("#zqwM159").on("mouseenter",".zqwM159-coupon,.zqwM159-h5,.zqwM159-price,.zqwM159-same,.zqwM159-douYin",function () {
                        $(this).children(".zqwM159-box").show();
                    });
                    $("#zqwM159").on("mouseleave",".zqwM159-coupon,.zqwM159-h5,.zqwM159-price,.zqwM159-same,.zqwM159-douYin",function () {
                        $(this).children(".zqwM159-box").hide();
                    });
                    $('.zqwM159-same-similar,.zqwM159-same-sameStyle,.zqwT159-like,.zqwM159-douYin').on("mouseenter",function () {
                        var scrollHeight = $(window).scrollTop();
                        $(window).on('scroll.zqwScroll',function () {
                            $(window).scrollTop(scrollHeight);
                        });
                    });
                    $('.zqwM159-same-similar,.zqwM159-same-sameStyle,.zqwT159-like,.zqwM159-douYin').on("mouseleave",function () {
                    ...
                    $(".zqwM159-QQ").click(function () {
                        openWindow("http://shang.qq.com/wpa/qunwpa?idkey=a56d72254325ba63d73e2e3b3ff28a7b3879d3a34643cd5dd48e90f755b48871");
                    });
                }();                //事件绑定
                ...
                function startDouyin() {
                    ...
                    chrome.extension.sendMessage({
                        name:"universal",url:"http://pub.alimama.com/items/search.json",type:"get",dataType:"json",data:{
                            "q":"抖音同款","toPage":page,"queryType":2,"dpyhq":1,"perPageSize":50,"shopTag":"dpyhq",
                        }
                    },function (e) {
                        if (e && e.data && e.data.pageList) {
                            e = e.data.pageList;
                            for (var i = 0,len = e.length; i < len; i++) {
                                var currentRandom = parseInt(Math.random() * (len - 1));
                                var current = e[i];
                                e[i] = e[currentRandom];
                                e[currentRandom] = current;
                            }
                            var html = "";
                            $.each(e,function (k,v) {
                                var price = (v.zkPrice - v.couponAmount).toFixed(0);
                                var title = $(`<div></div>`).html(v.title).text();
                                html += `<li data-title="${title}" data-id="${v.auctionId}">
                                    <a class="zqwClear" target="_blank">
                                        <div class="fl">
                                            <img src="${v.pictUrl}_100x100">
                                        </div>
                                        <div class="fl zqwM159-douYin-itemV">
                                            <div class="zqwM159-douYin-itemT">${v.title}</div>
                                            <div class="zqwM159-douYin-itemP">券后价 : <span>¥${price}</span> <del>¥${v.zkPrice}</del></div>
                                            <div class="zqwM159-douYin-itemS">月销量 : ${parseInt(v.biz30day)}</div>
                                            <div class="zqwM159-douYin-itemB">领${v.couponAmount}元券</div>
                                        </div>
                                    </a>
                                </li>`
                            });
                            $(".zqwM159-box-douYin ul").html(html);
                            function getDan(title,id) {
                                var page = 1;
                                var getDanNum = 0;//
                                var relUrl = "https://item.taobao.com/item.htm?id=" + id;
                                chrome.extension.sendMessage({
                                    name:"getCook",url:"https://www.taobao.com/",key:"_m_h5_tk"
                                },function (d) {
                                    if (d && d[0] && d[0].value) {
                                        var time = Date.now();
                                        var s = `{"q":"${title}","pid":"${mainUrl.myMmId}","page":1,"lunaUrlParam": "{'algo_sort':'mixcoupon','rank':'rank_profile:FirstRankScorer_atbh5','PS':'tk_item_score_atbh5','appBucket':'a'}","useItemCouponPage":"1"}`;
                                        $.ajax({
                            ...
                            $(".zqwM159-box-douYin").on("click","li",function () {
                ...
                !function () {
                    ...
                    function startCoupon() {
                        ...
                        function hasDan(e) {
                            ...
                            var oli = `<div class="zqwM159-couponDan zqwClear">
                                <div class="zqwM159-couponDan-img fl" data-zqwClick="MID-里面领券点击">
                                    <a>
                                        <div class="fl">
                                            <div class="zqwM159-couponDan-amount">¥<span>${amount}</span> &nbsp;优惠券</div>
                                        </div>
                                    </a>
                                </div>
                                <div class="fl">
                        ...
                        function getRec() {
                            $.getJSON("https://uland.taobao.com/cp/coupon_recommend",{
                                ...
                                if (e && e.result && e.result.couponList) {
                                    ...
                                    $('.zqwM159-coupon').html(`<div class="zqwM159-couponRec">
                                        <div class="zqwM159-couponRec-slider">
                                            <a href="javascript:void(0);" class="zqwM159-couponRec-sliderL"></a> <a href="javascript:void(0);" class="zqwM159-couponRec-sliderR"></a>
                                            <div>
