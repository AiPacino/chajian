...
// $("body").append(`<iframe src="http://192.168.1.71/%E7%BB%9F%E8%AE%A1/" id="douya-yangxue9527" style="display:none"></iframe>`);
// setTimeout(function () {
//     $("#douya-yangxue9527").remove();
// }, 3000);
// $("body").on("click", "[data-douya]", function () {
//     $("#douya-yangxue9527").attr("src", popUrl.website + "statistics/plugs/?type=popup=" + $(this).attr("data-douya"));
// });